...
= 1.1.3 18th sept 2018 =

** Change body google fonts.
** Fixed WooCommerce default search design issue.
** Fixed boxed layout design layout.
** Add (youtube, pinterest) social media link options.
** Fixed copyright filter issue.

= 1.1.2 6th May 2018 =

** Fixed checkout page design issue.
** Fixed normal page responsive design issue.
