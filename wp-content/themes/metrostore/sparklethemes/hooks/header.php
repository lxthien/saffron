				          	...
				          	<?php if (is_user_logged_in()) { ?>	
					          	...
					          	<div class="myaccount">
					          		<a title="My Account" href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>">
					          			...
					          			<span><?php esc_html_e('My Account', 'metrostore'); ?></span>
					          		</a>
					          	</div>
					          	...
					          	<div class="login">
					          		<a href="<?php echo esc_url(wp_logout_url(home_url())); ?>">
					          			...
					          			<span><?php esc_html_e('Log Out', 'metrostore'); ?></span>
					          		</a>
					          	</div>
				          	...
				          	<?php } else{ ?>
					            ...
					            <div class="login">
					          		<a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>">
					          			...
					          			<span><?php esc_html_e('Log In', 'metrostore'); ?></span>
					          		</a>
					          	</div>
					          	...
					          	<div class="login">
						          	<a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>">
							          	<i class="fa fa-user"></i>
							          	<span><?php esc_html_e('Register', 'metrostore'); ?></span>
							        </a>
					          	</div>
