...
$wp_customize->add_section('metrostore_social_link_activate_settings', array(
	'priority' => 24,
	'title'    => esc_html__('Social Media Link Settings', 'metrostore'),
));		
	...
	$metrostore_social_links = array(
		...
		'metrostore_social_pinterest' => array(
			'id' => 'metrostore_social_pinterest',
			'title' => esc_html__('Pinterest', 'metrostore'),
			'default' => ''
		),

		'metrostore_social_youtube' => array(
			'id' => 'metrostore_social_youtube',
			'title' => esc_html__('Youtube', 'metrostore'),
			'default' => ''
		)
	);
...
*/
	...
	*/
    $wp_customize->add_section('metrostore_copyright_message', array(
		'priority' => 1,
		'title'    => esc_html__('Copyright', 'metrostore'),
